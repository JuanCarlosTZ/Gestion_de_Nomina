               ...
               <form:errors path="*" element="div" cssClass="alert alert-danger"/>
                <p>
                   <label for="nombre">Nombre</label>
                    <input name="nombre" class="form-control" value="${tipoDeduccionModel.nombre}" type="text" placeholder="Nombre" minlength="1" maxlength="50" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}"   />
                </p>
                <p>
