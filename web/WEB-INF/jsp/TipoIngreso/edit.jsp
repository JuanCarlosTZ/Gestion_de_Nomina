...
<div class="container">
    <ol class="breadcrumb">
        ...
        <li class="active">Actualizando Ingresos</li>
    </ol>
    <div class="panel panel-primary">
        <div class="panel-heading text-center">Formulario de Tipos de Ingresos</div>
        <div class="panel-body">
            <form:form method="post" commandName="tipoIngresoModel" action="edit.htm">
                ...
                <h3>Actualizando Tipo de Ingreso</h3> 
